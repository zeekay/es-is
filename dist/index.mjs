...
export { isType, isDefined, isEmpty, isEqual, isHosted, isInstanceof, isNil, isUndefined, isArgs, isArray, isEmptyArgs, isEmptyArray, isArraylike, isBool, isFalse, isTrue, isDate, isValidDate, isElement, isError, isFunction, isNumber, isInfinite, isDecimal, isDivisibleBy, isInteger, isMaximum, isMinimum, isNan, even, odd, isge, gt, le, lt, within, isObject, isPrimitive, isHash, isRegexp, isString, isBase64, isHex, isSymbol };
